...
export default function CompletedTasks() {
    ...
    const handleFetchData = () => {
        setLoading(true)
        axios.get(`${process.env.NEXT_PUBLIC_HOST}/api/dashboard/completed-tasks/?userID=${user?.userID}`)
            .then(res => {
                ...
                <div className="w-full min-h-[calc(100vh-85px)] px-5 py-12">
                    <div className='nav-banner bg-[#f3f6ff] p-3 rounded-[5px]'>
                        <h2 className='font-bold text-[20px] text-[#333] flex items-center gap-2'>
                            ...
                            <span className='text-[20px] text-[#666]'>/ Completed Tasks</span>
                        </h2>
                    </div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" className="px-6 py-3 text-start text-[13px] font-bold text-[#6c5ce7] uppercase whitespace-nowrap">Completed On</th>
